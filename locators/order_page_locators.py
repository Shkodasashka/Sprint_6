...
class OrderPageLocators:
    ...
    FURTHER_BUTTON = (By.XPATH, "//div[contains(@class,'Order_NextButton')]/button[contains(@class,'Button_Button')]")  #кнопка перехода на следующую форму заказа
    ...
    FINAL_ORDER_BUTTON = (By.XPATH, "//div[contains(@class,'Order_Buttons')]/button[contains(text(),'Заказать')]") #итоговая кнопка для оформления заказа
    ...
    CONFIRMATION_SUCCESS_ORDER = (By.XPATH, "//div[contains(@class,'Order_ModalHeader')]") #окно подтверждения успешного выполнения заказа
